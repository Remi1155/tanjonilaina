...
const CustomLinkButton: React.FC<LinkButtonProps> = ({
  ...
  return (
    <a
      ...
      className={`px-4 py-3 my-1 border rounded-full  dark:invert ${bgColor} ${textColor} ${hoverStyle} transition hover:opacity-80 mx-2 text-sm font-semibold dark:border-gray-700 ${
