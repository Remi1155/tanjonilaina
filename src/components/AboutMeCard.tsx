...
const AboutMeCard: React.FC<AboutMeCardProps> = ({ imageUrl, title, items }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full p-2 bg-gray-100 border border-gray-300 shadow-md dark:border-gray-700 dark:bg-gray-800 rounded-3xl sm:h-full">
